...
trait Helper
{
    ...
    protected function wpb_post_query_controls()
    {
        ...
        $post_types['by_id'] = __('Manual Selection', 'wpb-elementor-addons');
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Query', 'wpb-elementor-addons'),
                'condition' => [
                    'content_source' => 'post',
                ],
            ]
        ...
        $this->add_control(
            'post_type',
            [
                'label' => __('Source', 'wpb-elementor-addons'),
        ...
        $this->add_control(
            'posts_ids',
            [
                'label' => __('Search & Select', 'wpb-elementor-addons'),
        ...
        $this->add_control(
            'authors', [
                'label' => __('Author', 'wpb-elementor-addons'),
                'label_block' => true,
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'default' => [],
        ...
        $this->add_control(
            'post__not_in',
            [
                'label' => __('Exclude', 'wpb-elementor-addons'),
                'type' => Controls_Manager::SELECT2,
                'options' => $this->wpb_get_all_types_post(),
                'label_block' => true,
                'post_type' => '',
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __('Posts Per Page', 'wpb-elementor-addons'),
        ...
        $this->add_control(
            'offset',
            [
                'label' => __('Offset', 'wpb-elementor-addons'),
                'type' => Controls_Manager::NUMBER,
                'default' => '0',
            ]
        );
        ...
        $this->add_control(
            'orderby',
            [
                'label' => __('Order By', 'wpb-elementor-addons'),
                'type' => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'order',
            [
                'label' => __('Order', 'wpb-elementor-addons'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'asc' => __('Ascending', 'wpb-elementor-addons'),
                    'desc' => __('Descending', 'wpb-elementor-addons'),
                ],
                'default' => 'desc',
    ...
    protected function wpb_category_query_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Category Query', 'wpb-elementor-addons'),
                'condition' => [
        ...
        $this->add_control(
            'category_taxonomy',
            [
                'label' => __('Taxonomy', 'wpb-elementor-addons'),
                'type' => Controls_Manager::SELECT,
                'options' => $taxonomies,
        ...
        $this->add_control(
			'term_hide_empty',
			[
				'label' => __( 'Hide Empty', 'wpb-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'wpb-elementor-addons' ),
				'label_off' => __( 'No', 'wpb-elementor-addons' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
        ...
        $this->add_control(
            'term_number',
            [
                'label' => __( 'Number of items to show', 'wpb-elementor-addons' ),
    ...
    protected function wpb_menu_query_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Menu Query', 'wpb-elementor-addons'),
                'condition' => [
                    'content_source' => 'menu',
                ],
            ]
        ...
        $this->add_control(
            'menu_to_show',
            [
                'label' => __('Select a Navigation Menu', 'wpb-elementor-addons'),
                'type' => Controls_Manager::SELECT,
    ...
    {
        $orderby = array(
            'ID'            => __( 'Post ID', 'wpb-elementor-addons' ),
            'author'        => __( 'Post Author', 'wpb-elementor-addons' ),
            'title'         => __( 'Title', 'wpb-elementor-addons' ),
            'date'          => __( 'Date', 'wpb-elementor-addons' ),
            'modified'      => __( 'Last Modified Date', 'wpb-elementor-addons' ),
            'parent'        => __( 'Parent Id', 'wpb-elementor-addons' ),
            'rand'          => __( 'Random', 'wpb-elementor-addons' ),
            'comment_count' => __( 'Comment Count', 'wpb-elementor-addons' ),
            'menu_order'    => __( 'Menu Order', 'wpb-elementor-addons' ),
        );
    ...
    {
        $orderby = array(
            'name' 			=> __( 'Name', 'wpb-elementor-addons' ),
            'count' 		=> __( 'Count', 'wpb-elementor-addons' ),
            'slug' 			=> __( 'Slug', 'wpb-elementor-addons' ),
            'term_group' 	=> __( 'Term Group', 'wpb-elementor-addons' ),
            'term_order' 	=> __( 'Term Order', 'wpb-elementor-addons' ),
            'term_id' 		=> __( 'Term ID', 'wpb-elementor-addons' ),
            'include' 		=> __( 'Include', 'wpb-elementor-addons' ),
            'slug__in' 		=> __( 'Slug In', 'wpb-elementor-addons' ),
            'none' 		    => __( 'None', 'wpb-elementor-addons' ),
        );
