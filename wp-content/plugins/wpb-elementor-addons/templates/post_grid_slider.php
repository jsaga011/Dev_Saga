                        ...
                        echo '<div class="wpb-ea-post-carousel content-alignment-'. esc_attr( $wpb_ea_post_content_align ) .'">';
                            ...
                            if( $settings['wpb_ea_show_post_image'] == 'yes' && has_post_thumbnail() ) :  
                                ...
                                echo '<div class="post-thumbnail">';
                                    ...
                                    if ( class_exists( 'woocommerce' ) && $settings['post_types'] == 'product' && $settings['wpb_ea_show_tag_for_featured_product'] == 'yes' && !empty($settings['wpb_ea_featured_product_tag_text']) ) {
                            ...
                            echo '<div class="post-info">';
                                echo '<div class="post-content">';
                                    ...
                                    if ( class_exists( 'woocommerce' ) && $settings['post_types'] == 'product' && $settings['wpb_ea_product_review'] == 'yes' ) :
