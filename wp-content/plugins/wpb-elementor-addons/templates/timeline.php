					...
					<div class="wpb-timeline-block">
						...
						<div class="wpb-timeline-content">
							<?php if( $item['date'] && $settings['wpb_ea_disable_date'] != 'yes' ): ?>
								<div class="wpb-timeline-date"><span class="wpb-timeline-date-inner"><?php echo date_i18n( apply_filters( 'wpb_ea_timeline_date_format', get_option( 'date_format' ) ) , strtotime( $item['date']) ); ?></span></div>
							<?php endif; ?>
